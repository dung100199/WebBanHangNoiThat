...
<div class="container mt-4 mb-5">
    ...
    <ul class="nav nav-tabs mb-4" id="adminTab">
        <li class="nav-item">
            <a class="nav-link active" href="#" onclick="showTab('san-pham', this)">🛋️ Sản phẩm</a>
        </li>
        <li class="nav-item">
    ...
    <div id="tab-san-pham">
                ...
                <form action="/admin/edit-product" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="keyword" class="form-control"
                                       placeholder="Để trống nếu không đổi ảnh">
                    ...
                    <div class="mb-3">
                        ...
                        <img src="${product.image}"
                             style="height:100px; object-fit:cover; border-radius:6px; border:1px solid #ddd;">
                    </div>
        ...
        <!-- DANH SÁCH SẢN PHẨM -->
        <h5>📋 Danh sách sản phẩm (${products.size()} sản phẩm)</h5>
            ...
            <tbody>
                <c:forEach var="p" items="${products}">
                    <tr>
                        ...
                        <td>
                            <a href="/admin/edit-product/${p.id}" class="btn btn-warning btn-sm">✏️ Sửa</a>
                        </td>
                        <td>
