...
<head>
    ...
    <style>
        ...
        .section-title {
            font-size: 18px; font-weight: 700; color: #1a2a5e;
        ...
        .order-item-left { display: flex; align-items: flex-start; gap: 8px; flex: 1; }
        .order-item-left img { height: 45px; width: 45px; object-fit: cover; border-radius: 4px; flex-shrink: 0; }
        .order-item-name { font-size: 14px; }
        .order-item-variant { font-size: 12px; color: #888; margin-top: 2px; }
        .order-item-qty { font-size: 13px; color: #999; margin-top: 2px; }
        .order-item-price { white-space: nowrap; margin-left: 8px; font-size: 14px; }
        .order-total {
            display: flex; justify-content: space-between;
            padding: 14px 0 0; font-weight: 700; font-size: 16px; color: #e00;
        }
        .payment-method {
        ...
        .btn-order {
            background: #e00; color: white; width: 100%;
            padding: 14px; font-size: 16px; font-weight: 700;
            border: none; border-radius: 6px; margin-top: 16px;
        }
        ...
        <div class="col-md-7">
            ...
            <div class="bg-white p-4 rounded border">
                ...
                <div id="bank-info" class="bank-info">
                    ...
                    Chủ tài khoản: <strong>MOHO</strong><br>
                ...
                <div id="qr-info" style="display:none; text-align:center; padding:20px;
                    ...
                    <img src="https://img.vietqr.io/image/VCB-1039914852-compact2.png?amount=${total}&addInfo=Thanh%20toan%20don%20hang%20MOHO&accountName=MOHO"
                         alt="QR thanh toán"
                    ...
                    <p style="font-size:12px; color:#888; margin-top:12px; line-height:1.8;">
                        ...
                        Nội dung: <strong>Thanh toán đơn hàng MOHO</strong>
                    </p>
                </div>
